...
// base_tester.php
$string['shellerr_notfile'] = '"{$a}" не является файлом.';
$string['shellerr_notreadable'] = 'Файл "{$a}" не доступен для чтения.';
$string['shellerr_cantread'] = 'Для файла "{$a}" нет подходящего ридера.';
...
$string['group1_excel'] = 'Сравнить текст';
...
$string['group2_excel'] = 'Сравнить стили';
...
$string['group3_excel'] = 'Сравнить диаграммы';
...
$string['group1_powerpoint'] = 'Сравнить текст';
...
$string['group2_powerpoint'] = 'Форматирование';
...
$string['group1_word'] = 'Сравнить текст';
...
$string['group2_word'] = 'Сравнить стиль';
...
$string['group3_word'] = 'Сравнить макет';
