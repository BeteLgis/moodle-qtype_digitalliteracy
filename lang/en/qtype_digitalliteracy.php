...
$string['grouptwo_help_text_excel'] = 'Compare style by selected options. Fill color compares start color (it matters when a gradient is used). Font compares: name, size, underline, (text) color and italic.';
